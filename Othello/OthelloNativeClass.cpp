...
void OthelloNativeClass::ChangePices(int x, int y, int8 piceColor, int boardSize, TArray <int32>arrOthelloButton)
{
...
// 둘수 있는 위치를 표시해주는 함수
bool OthelloNativeClass::PutOthello(int x, int y, int8 piceColor, int boardSize, TArray <int32>arrOthelloButton)
{
