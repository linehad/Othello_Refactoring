...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FSinglePlacementEvent, FName, PropertyName, const FBoardInfoStruct&, BoardInfoStruct);
UCLASS()
...
public:
	...
	UPROPERTY()
		FSinglePlacementEvent OnSinglePlacementEvent;
	UFUNCTION()
		void BindEvent();
